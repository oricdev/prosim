...
public class ComputingInstance {
    // START // Note to user: please fill in the constants below with your data (check your email in order to get a validation status from the Admin)
    //.. nick name of your database in 1 single word with no spaces, no special chars except "_" (used for building progression statistics, in OFF_GRAPH App to add your own graph, to query your db through the PROSIM-Engine API, etc.)
    ...
    //.. summary of the purpose of the database (ex.: products without gluten, vegan products, etc.)
    ...
    //.. db will store only comparisons which have minimum this percentage (0=all intersections, 60=similarity of pairs of products with a minimum of 60%, etc.)
    public static final String SIMILARITY_MIN_PERCENTAGE = "60";
    //.. your name, nick name (will be displayed in statistics, help, as creator of the database)
    public static final String YOUR_NAME = "oric.dev";
    //.. your email address to receive a validation status of your db-request from the Admin
    ...
    /* Occurs first! computeScore and computeSimilarity will be launched only filetered products.
    ...
    */
    ...
    /*
    * Products are already filtered
    * compute score (nutrition score, nova score, your own score)
    * Result: 1 is bottom in the graph, 5 is top
    * Note: you may return any value, th graph adapts (or will adapt) automatically, or build your own graph using the PROSIM API
    */
