...
public class products extends Product {
    ...
    public products(String _id, String code, String product_name, String pnns_groups_1, List<String> countries_tags, List<String> categories_tags, List<String> ingredients_tags, List<String> brands_tags, List<String> stores_tags, Object languages_codes, Object nutriments, Double nova_group, Object images, String nutrition_grades) {
        super(_id, code, product_name, pnns_groups_1, countries_tags, categories_tags, ingredients_tags, brands_tags, stores_tags, languages_codes, nutriments, nova_group, images, nutrition_grades);
    }
}
