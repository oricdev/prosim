...
public class ComputingInstance {
    ...
    ** ***************************************************** */
    ...
    public static final String SCORE_LABEL_Y_AXIS = "Nutrition score";
    ...
    public static final Short SCORE_NB_INTERVALS = 5;
    ...
    public static final String[] SCORE_INTERVALS_LABELS = {"E", "D", "C", "B", "A"};
    ...
    ** ******************** */
    ...
    public static Short computeScore(ProductExt product) {
         ...
         * score = 1 => E, ... score = 5 => A (see SCORE_INTERVALS_LABELS above)
         */
        Short score = null;
        if (product.getNutritionGrades() != null) {
            String score_uk = product.getNutritionGrades();
            if (score_uk.equalsIgnoreCase("e")) {
                score = 1;
            } else if (score_uk.equalsIgnoreCase("d")) {
                score = 2;
            } else if (score_uk.equalsIgnoreCase("c")) {
                score = 3;
            } else if (score_uk.equalsIgnoreCase("b")) {
                score = 4;
            } else {
                score = 5;
            }
